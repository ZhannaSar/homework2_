...
#Note *we used random generator and thus results may vary, each time the code is run*
...
```
As the p-value 0.0811 is grater than 0.05 significance level, in this case we do not reject null hypothesis and conclude that dice is fair.
